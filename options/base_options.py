...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default='./HDR_img', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--style_weight_A', type=float, default=1e-4, help='the weight of style loss, 0 means don not apply')
        ...
        parser.add_argument('--lambda_gp', type=float, default=10.0, help='scaling factor for gradient peniety for wgan.')
